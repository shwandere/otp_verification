...
List<DropdownMenuItem<String>> get dropdownItems{
  ...
  //State<DropdownButton> createState() => _DropdownItemState();
  return menuItems;
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Flutter Demo', textDirection: TextDirection.ltr),
        //home: DropdownItem(),
      ),
      body: Center(
            ...
            child: Column(
              ...
              DropdownButtonFormField(
                ...
                ElevatedButton(
                    ...
                    child: Text("Submit", textDirection: TextDirection.ltr))
              ],
            )),
    );
  }
